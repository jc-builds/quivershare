...
<main>
  ...
  <section class="relative w-full overflow-hidden" aria-labelledby="hero-title">
    <div class="relative h-[50vh] min-h-[360px] md:h-[56vh] md:min-h-[440px] lg:h-[60vh]">
      ...
      <div class="absolute inset-0 flex items-end">
        <div class="w-full px-4 md:px-8 pb-14 md:pb-12 lg:max-w-6xl lg:mx-auto">
  ...
  {#if data.featuredBoards.length > 0}
    <section class="bg-background pt-8 pb-8 md:pt-10 md:pb-10" aria-labelledby="inventory-title">
      <div class="max-w-7xl mx-auto px-4 md:px-8">
        <div class="flex items-baseline justify-between mb-6">
          ...
          <a
            href="/s"
            class="text-sm font-medium text-foreground/70 hover:text-foreground transition-colors whitespace-nowrap"
            data-sveltekit-prefetch
          >
            View all &rarr;
          </a>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
          {#each data.featuredBoards as board, index (board.id)}
            <BoardCard {board} eager={index < 2} showAttribution={true} />
          {/each}
        </div>
  ...
  <!-- Entry Points -->
  <section class="bg-muted py-8 md:py-12" aria-labelledby="entry-points-title">
    <div class="max-w-5xl mx-auto px-4 md:px-8">
      ...
      <div class="grid gap-4 md:grid-cols-3 md:gap-5">
        ...
        >
          ...
          <span class="mt-4 text-sm font-medium text-foreground/70 group-hover:text-foreground transition-colors">
            Browse boards &rarr;
          </span>
        </a>
        <a
