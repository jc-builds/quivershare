...
>
  ...
  >
    ...
    <div class="ml-auto flex items-center gap-4 md:gap-6">
      ...
      >
        {#if isActiveUser}
          <a href="/s" class="hover:text-foreground" data-sveltekit-prefetch
            >Browse Boards</a
          >
          <a
            href="/my-boards"
            class="hover:text-foreground"
            data-sveltekit-prefetch>My Boards</a
          >
        {:else}
          <a href="/s" class="hover:text-foreground" data-sveltekit-prefetch
            >Browse Boards</a
          >
          <a href="/help" class="hover:text-foreground" data-sveltekit-prefetch
            >Help</a
          >
          <a href="/about" class="hover:text-foreground" data-sveltekit-prefetch
            >About</a
          >
        {/if}
      </div>
      {#if isActiveUser}
        ...
        >
          <span class="nav-li-font"
            >Boost Balance: <span class="font-semibold ml-1"
              >{boostBalance}</span
            ></span
          >
        </button>
        ...
        {#if mobileMenuOpen}
          ...
          >
            ...
            <div
              class="px-4 py-2 text-sm text-muted-foreground flex items-center justify-between border-b border-border"
            >
              <span>Balance</span>
